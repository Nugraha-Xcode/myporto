...
export function FloatingNav() {
  ...
  return (
    <>
          ...
          {isMobile ? (
            <div className="relative flex items-center justify-between">
              <Link href="/" className="font-bold text-lg">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600">Nugraha</span>
      ...
      {isMobile && (
        <motion.div
          className={`fixed inset-0 bg-black/90 backdrop-blur-md ${isOpen ? "block" : "hidden"}`}
          style={{ zIndex: 30 }}
          initial={{ opacity: 0 }}
